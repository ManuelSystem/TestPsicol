            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('reports.students')" :active="route().current('reports.students')">
                                    Reportes
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('grupos.index')" :active="route().current('grupos.index')">
                            Grupos
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('reports.students')" :active="route().current('reports.students')">
                            Reportes
                        </ResponsiveNavLink>
                    </div>
