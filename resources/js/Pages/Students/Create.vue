        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="$event => form.post(route('estudiantes.store'), { onSuccess: showAlert })"
                        ...
                        <div class="flex flex-wrap -mx-4">
                            ...
                            <div class="w-full sm:w-1/2 px-4 mb-4">
                                ...
                                <select :id="'semester'" v-model="form.semester" :class="'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full'" required>
